    ...
    <section>
              ...
              <div class="container mx-auto pt-10 px-4 sm:px-6 lg:px-8">
                ...
                <label class="" for="room_no" style="position:relative; left: -265px; top: -65px;">Check-in Date:</label><br>
                  ...
                  <input
                    ...
                    id="check_in_date" name="check_in_date" type="date" style="width: 475px;height:50px;position:relative; left: -265px; top: -65px;" value="{{ old('check_in_date') }}">
              ...
              <div class="space-y-4 font-regular text-base sm:text-lg pb-10 ">
                ...
                <label class="" for="room_no" style="position:relative; left: -265px; top: -65px;" >Check-out Date:</label><br>
                  ...
                  <input
                    class="w-full border-gray-900 rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500"
                    id="check_in_date" name="check_out_date" type="date" style="width: 475px;height:50px;position:relative; left: -265px; top: -65px;" value="{{ old('check_in_date') }}">
