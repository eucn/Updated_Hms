          ...
          <div class="justify-between mx-[50px]">
                ...
                <div class="space-y-4 font-regular text-base sm:text-lg pb-10 ">
                  <div class="flex flex-col lg:flex-row justify-center">
                    <div class="mx-4 md:mx-4 py-3" style="position:relative; left: -250px; ">
                      ...
                      <select class="w-full md:w-[475px]" name="room_type" id="room_type" value="{{ old('room_type') }}"
            ...
            <div class="grid grid-cols-1 mt-1">
              <div class=" py-2 flex items-center">
                <label style="position:relative; top: -80px; left: -95px;" class="block text-gray-900 font-medium mr-4"
                  for="number-of-nights">Number of Nights:</label>
