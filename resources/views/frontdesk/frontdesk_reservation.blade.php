  ...
  <main id="main" class="main">
    ...
    <section class="col-md-11 mx-auto">
              <div class="container  px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="bg-white rounded-lg shadow-md border-2 w-full " style="height: 350px;">
                          ...
                          <div class="flex flex-col lg:flex-row justify-center">
                            <div class="mx-4 md:mx-4 py-3" style="position:relative; left: -250px; ">
                                ...
                                <select class="w-full md:w-[475px]" name="room_type" id="room_type" value="{{ old('room_type') }}" placeholder="Single Size">
                                  <option value="Single Size" {{ old('room_type') == 'Single' ? 'selected' : '' }}>Single Size</option>
                                  <option value="Queen Size" {{ old('room_type') == 'Queen' ? 'selected' : '' }}>Queen Size</option>
                      ...
                      <div class="space-y-4 font-regular text-base sm:text-lg pb-10 ">
                          <div class="flex flex-col lg:flex-row justify-center">
                            <div class="mx-4 md:mx-4 py-3" style="position:relative; left: 250px; top: -145px; ">
                                ...
                                <select class="w-full md:w-[475px]" name="room_no" id="room_no" value="{{ old('room_no') }}" placeholder="1 ">
                ...
                <div class=" py-2">
                <label class="" for="room_no" style="position:relative; left: -265px; top: -65px;">Check-in Date:</label><br>
               
                  <input
                    class="w-full border-gray-900  py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500"
                    id="check_in_date" name="check_in_date" type="date" style="width: 475px;height:50px;position:relative; left: -265px; top: -65px;border-color: gray;" value="{{ old('check_in_date') }}">
              ...
              <div class="space-y-4 font-regular text-base sm:text-lg pb-10 ">
                      ...
                      <div class="grid grid-cols-1 ">
                <div class=" py-2">
                <label class="" for="room_no" style="position:relative; left: -265px; top: -65px;" >Check-out Date:</label><br>
                ...
                <div class=" py-2 flex items-center">
                  <label style = "position:relative; top: -80px; left: -94px;"class="block text-gray-900 font-medium mr-4" for="number-of-nights">Number of Nights:</label>
